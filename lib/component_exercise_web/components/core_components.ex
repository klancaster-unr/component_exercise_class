defmodule ComponentExerciseWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ComponentExerciseWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ComponentExerciseWeb.Gettext, "errors", msg, opts)
    end
  end
